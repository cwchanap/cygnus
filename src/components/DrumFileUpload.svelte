...
<div class="w-full">
  {#if !uploadedFile}
    <div
      class="border-2 border-dashed rounded-lg p-8 text-center transition-colors {dragover ? 'border-purple-500 bg-purple-50' : 'border-gray-300 hover:border-gray-400'}"
  ...
  {:else}
    <div class="bg-green-50 border border-green-200 rounded-lg p-6">
      <div class="flex items-center justify-between mb-4">
        <div>
          <h3 class="text-lg font-semibold text-green-800">File Ready</h3>
      ...
      <button
        ...
        disabled={isStarting}
        class="w-full px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
      >
        {#if isStarting}
